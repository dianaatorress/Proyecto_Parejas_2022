...
// Esta function es para que la página no muestre las preguntas en orden
// Onload es para que una vez que el todo DOM está listo, la página pueda correr
window.onload = function () {
  base_preguntas = readText("base-preguntas.json");
  // Interprete bp es para poder traducir y que pueda leer bien la base de preguntas
